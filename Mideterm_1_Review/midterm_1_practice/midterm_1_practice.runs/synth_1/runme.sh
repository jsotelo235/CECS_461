...
HD_PWD='D:/CSULB_Classes/CECS_461/Mideterm_1_Review/midterm_1_practice/midterm_1_practice.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log midterm_1_practice_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source midterm_1_practice_wrapper.tcl
