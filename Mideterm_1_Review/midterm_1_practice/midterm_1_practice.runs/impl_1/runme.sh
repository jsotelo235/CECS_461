...
HD_PWD='D:/CSULB_Classes/CECS_461/Mideterm_1_Review/midterm_1_practice/midterm_1_practice.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log midterm_1_practice_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source midterm_1_practice_wrapper.tcl -notrace
